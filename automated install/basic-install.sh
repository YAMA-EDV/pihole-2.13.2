...
# 2015-2018 Yama Industrials, Corporation - Cloud-Protect
# Installs Pi-hole
#
...
webInterfaceGitUrl="https://github.com/YAMA-EDV/AdminLTE-2.5.2"
webInterfaceDir="/var/www/html/admin"
piholeGitUrl="https://github.com/YAMA-EDV/pihole-2.13.2"
...
welcomeDialogs() {
  ...
  whiptail --msgbox --backtitle "Plea" --title "Free and open source" "\n\n Pi-hole is open-source, 2015-2018 Yama Industrials, Corporation - Cloud-Protect" ${r} ${c}
...
main() {
  ...
  if [[ ${EUID} -eq 0 ]]; then
    ...
    if command -v sudo &> /dev/null; then
      ...
      exec curl -sSL https://github.com/YAMA-EDV/pihole-2.13.2/tree/master/automated%20install/basic-install.sh | sudo bash "$@"
      exit $?
    else
